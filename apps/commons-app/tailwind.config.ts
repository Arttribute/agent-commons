...
export default {
  ...
  content: {
    ...
    files: [
      ...
      "../commons-desktop/renderer/**/*.{js,ts,jsx,tsx}",
    ],
  },
  theme: {
    extend: {
      fontFamily: {
        // Space Grotesk is the shared brand face across headings, labels and body copy.
        space: [
      ...
      boxShadow: {
        ...
        composer:
          "0 12px 32px -12px rgba(28, 25, 23, 0.14), 0 4px 12px -4px rgba(28, 25, 23, 0.08), 0 1px 3px rgba(28, 25, 23, 0.05)",
