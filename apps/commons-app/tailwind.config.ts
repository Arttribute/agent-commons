  ...
  theme: {
  	extend: {
  		boxShadow: {
  			...
  			// Neutral depth plus a faint teal glow — the same accent as the
  			// highlighted page titles — so the composer reads softly branded.
  			composer: '0 12px 32px -12px rgba(28, 25, 23, 0.12), 0 4px 12px -4px rgba(28, 25, 23, 0.07), 0 0 28px -6px rgba(45, 212, 191, 0.22), 0 1px 3px rgba(28, 25, 23, 0.05)',
