...
export const NODE_THEME: Record<string, NodeTheme> = {
  input: {
    ...
    label: "Input",
    tile: "bg-emerald-200/80 text-emerald-950 dark:bg-emerald-300/20 dark:text-emerald-200",
  ...
  output: {
    ...
    label: "Output",
    tile: "bg-violet-200/80 text-violet-950 dark:bg-violet-300/20 dark:text-violet-200",
  ...
  tool: {
    icon: Wrench,
    label: "Tool",
    tile: "bg-blue-200/70 text-blue-950 dark:bg-blue-300/20 dark:text-blue-200",
  ...
  agent_processor: {
    icon: Bot,
    label: "Agent",
    tile: "bg-cyan-200/70 text-cyan-950 dark:bg-cyan-300/20 dark:text-cyan-200",
  ...
  workflow: {
    icon: Workflow,
    label: "Workflow",
    tile: "bg-indigo-200/70 text-indigo-950 dark:bg-indigo-300/20 dark:text-indigo-200",
  ...
  condition: {
    icon: GitBranch,
    label: "Condition",
    tile: "bg-amber-200/80 text-amber-950 dark:bg-amber-300/20 dark:text-amber-200",
  ...
  transform: {
    icon: Replace,
    label: "Transform",
    tile: "bg-pink-200/70 text-pink-950 dark:bg-pink-300/20 dark:text-pink-200",
  ...
  loop: {
    icon: Repeat2,
    label: "Loop",
    tile: "bg-rose-200/70 text-rose-950 dark:bg-rose-300/20 dark:text-rose-200",
  ...
  human_approval: {
    icon: CheckSquare,
    label: "Approval",
    tile: "bg-teal-200/70 text-teal-950 dark:bg-teal-300/20 dark:text-teal-200",
