...
export default function ExternalAgentForm() {
  ...
  return (
    <>
      {!result ? (
        // Show Form
        <Card className="p-8 max-w-lg mx-auto border border-border">
          <div className="mb-12">
        ...
        <Card className="p-6 max-w-lg mx-auto border border-border">
          <div className="mb-8">
            <div className="bg-emerald-300 w-80 h-8 -mb-8 rounded-lg"></div>
          ...
          <div className="flex justify-between items-center bg-muted px-4 p-1 rounded">
            <p className="text-sm">
