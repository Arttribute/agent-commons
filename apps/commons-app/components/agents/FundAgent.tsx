 ...
 */
export function FundAgent({ agentAddress, onFundSuccess }: FundAgentProps) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Send Common$ tokens from your balance to this agent.
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter>
          {/* Only show "Fund Agent" if user has a non-zero balance */}
          {userBalance > 0n && (
            <Button
