...
x402 is a payment protocol for HTTP resources. When your agent requests a paid URL that returns a 402 Payment Required response, it automatically pays and retries.
