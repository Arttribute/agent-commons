    ...
    challenges: [
      {
        ...
        keyIdeas: [
          "One agent can carry too much work inside one context.",
          "Multiple agents help when work benefits from focused contexts.",
          "Parallelism, specialization, and verification are strong reasons to split work across agents.",
          "More agents also add coordination cost, latency, and debugging difficulty.",
        ],
        microTask:
          "Choose one task and decide whether it deserves multiple agents. Name the focused contexts you would split out, then name one coordination cost you would need to manage.",
        questions: [
          {
            id: "q1",
            prompt: "When does it make the most sense to use multiple agents?",
            options: [
              "When the work benefits from being split across focused contexts",
              "Whenever a task mentions more than one file",
              "Whenever one agent could answer but a team sounds more impressive",
              "When every agent should see the same full context and do the same work",
            ],
            answerIndex: 0,
            explanation:
              "Multiple agents are useful when splitting the work creates clearer focused contexts, not when agents are added for decoration.",
          },
          {
            id: "q2",
            prompt: "Which option names the three cases from the lesson where multiple agents usually help?",
            options: [
              "Parallelism, specialization, and verification",
              "Decoration, duplication, and longer prompts",
              "Memory, color, and personality",
              "More tools, more messages, and more unfinished work",
            ],
            answerIndex: 0,
            explanation:
              "The lesson names parallel work, specialized roles or capabilities, and checking another agent's output as strong reasons to split the system.",
          },
          {
            id: "q3",
            prompt: "What tradeoff should you remember before adding more agents?",
            options: [
              "More agents can increase coordination, cost, latency, and debugging difficulty",
              "More agents always reduce coordination work",
              "More agents remove the need to verify outputs",
              "More agents guarantee every result will be cheaper and faster",
            ],
            answerIndex: 0,
            explanation:
              "Multiple agents can help, but the extra moving parts also make coordination and debugging harder.",
          },
        ],
      },
      {
