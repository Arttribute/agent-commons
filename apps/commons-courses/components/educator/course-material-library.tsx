...
export function CourseMaterialLibrary({ slug }: { slug: string }) {
  ...
  async function upload(files: FileList | null) {
    ...
    if (res.ok) {
      ...
      setNotice(visibility === "live" ? "Uploaded as live-attendee-only material and added to your Commons Library." : "Uploaded privately to this course and added to your Commons Library.");
