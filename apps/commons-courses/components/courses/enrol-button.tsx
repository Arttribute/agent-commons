  ...
  return (
    <>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-slate-900 text-white text-sm font-semibold hover:opacity-90 transition-opacity"
      >
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
            ...
            <div className="px-6 py-5 border-t border-slate-100 space-y-4">
                ...
                <div className="space-y-3">
                  {googleAvailable && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-200 px-5 py-2.5 text-sm font-semibold text-slate-800 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-40"
                    >
                      <GoogleLogo />
              ...
              <button
                ...
                disabled={!checked || accepting}
                className="w-full flex items-center justify-center gap-2 px-5 py-3 rounded-lg bg-slate-900 text-white text-sm font-semibold hover:opacity-90 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {accepting ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : null}
