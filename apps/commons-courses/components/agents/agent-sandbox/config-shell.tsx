...
export function ConfigDrawer({
  ...
  return (
    <div
      className={cn(
        "absolute inset-y-0 left-14 z-30 w-[min(420px,calc(100%-3.5rem))] border-r border-slate-200 bg-white shadow-xl transition-transform lg:relative lg:left-0 lg:shadow-none",
