...
const AgentSandboxConfigSchema = new Schema(
  {
    ...
    placeholders: {
      ...
      persona: { type: String, trim: true },
      systemPrompt: { type: String, trim: true },
      skillInstructions: { type: String, trim: true },
      chatInput: { type: String, trim: true },
    },
    starterSkillIds: { type: [String], default: undefined },
    starterToolIds: { type: [String], default: undefined },
