...
export const privacyPolicy: LegalDocument = {
  ...
  description:
    "How Agent Commons collects, uses, shares, protects, and retains personal data across CommonLab and the wider Agent Commons ecosystem.",
  effectiveDate: legalMeta.effectiveDate,
  intro: [
    `This Privacy Policy explains how ${legalMeta.company} collects, uses, discloses, and protects personal data when you use ${legalMeta.product} and the wider ${legalMeta.ecosystem}, including ${legalMeta.agentCommonsApp}, Commons Identity, APIs, SDKs, course experiences, agent workspaces, and related services.`,
  ...
  sections: [
    {
      ...
      body: [
        `${legalMeta.company} is the controller of personal data processed for account management, platform operation, course delivery, billing support, safety, analytics, and communications. Where educators, organizations, or developers use our services to process personal data on behalf of others, they may be the controller and Agent Commons may act as a processor or service provider under a separate agreement.`,
    ...
    },
    {
      ...
      body: [
        "This policy covers current and future products in the Agent Commons ecosystem, including CommonLab for courses, labs, skill paths, educator tools, and learner sandboxes; the main Agent Commons platform for creating, discovering, and collaborating with agents; Commons Identity for authentication and account federation; and developer-facing APIs, SDKs, CLIs, and integrations.",
      ],
    },
    {
      ...
      bullets: [
        ...
        "Course and learner data, such as enrollments, progress, submissions, badges, certificates, sandbox activity, educator-created content, live session participation, and support requests.",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Create and manage accounts, authentication, permissions, enrollments, course access, workspaces, and developer credentials.",
        ...
        "Measure reliability, usage, product performance, learning progress, and course completion.",
...
export const termsOfService: LegalDocument = {
  ...
  description:
    "Terms governing access to and use of CommonLab, Agent Commons, Commons Identity, APIs, SDKs, agents, workflows, courses, and related services.",
  effectiveDate: legalMeta.effectiveDate,
  intro: [
    `These Terms of Service govern your access to and use of ${legalMeta.product} and the wider ${legalMeta.ecosystem}, including ${legalMeta.agentCommonsApp}, Commons Identity, APIs, SDKs, CLIs, websites, courses, labs, agent workspaces, tools, integrations, and related services.`,
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        "The services may include course delivery, labs, learner sandboxes, educator consoles, badges, certificates, agent creation and discovery, spaces, sessions, workflow automation, tasks, tools, memory, logs, API access, SDKs, OAuth connections, MCP tools, payments, credits, and identity services.",
    ...
    {
      title: "4. CommonLab Course Terms",
      bullets: [
        ...
        "Course access may depend on payment status, cohort dates, educator settings, or product availability.",
        ...
        "Live sessions may be recorded and made available to enrolled learners. If you participate, your name, voice, image, chat messages, or submitted work may appear in the recording.",
      ],
    },
    {
      title: "5. Agent Commons Platform Terms",
      bullets: [
