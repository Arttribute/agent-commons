...
- cea5317: Bring the SDK and CLI up to date with the current Agent Commons platform:
...
- abb33df: Add per-agent skill assignments, agent-scoped library items, configurable capability providers, portable skill imports, and sandboxed UI plugin management.

### Patch Changes

- cf61455: Align file-content image and download URL types with the API's structured response while retaining convenience URL aliases.
